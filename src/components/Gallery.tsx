...
const galleryImages = [
  ...
  '/Bệnh Viện TY Gia Kiệm [12-01-2026 18_18]/1924876500024347966.jpg',
  '/Bệnh Viện TY Gia Kiệm [12-01-2026 18_18]/1924876500024347967.jpg',
  ...
  '/Bệnh Viện TY Gia Kiệm [12-01-2026 18_48]/22405269345650303039.jpg',
  '/Bệnh Viện TY Gia Kiệm [12-01-2026 18_48]/27833439738440628338.jpg',
  ...
  '/Bệnh Viện TY Gia Kiệm [12-01-2026 18_48] (1)/348607439431384236214.jpg',
  '/Bệnh Viện TY Gia Kiệm [12-01-2026 18_48] (1)/348607439431384236215.jpg',
  ...
  '/Bệnh Viện TY Gia Kiệm [12-01-2026 18_49]/65308d2a75bcfae2a3ad29.jpg',
];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
          {galleryImages.map((image, index) => (
            ...
            >
              <img
                src={image}
                alt={`Bệnh viện Thú Y Gia Kiệm - Hình ${index + 1}`}
